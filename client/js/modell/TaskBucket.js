 ...
 */
const { TASK_STATUS_VALUES, TASK_RETRIEVALSTATUS } = require('./TaskGlobals');

const ToDoPersistor = require('./persist');
    ...
    constructor(sendStateFunc, userHandle, persistenceServiceURI = null) {
       ...
       */
        this.persistenceService = persistenceServiceURI ?
            new ToDoPersistor(persistenceServiceURI, this[processServiceResult]) :
            null;
